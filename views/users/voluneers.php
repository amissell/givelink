...
<head>
    ...
    <title>GiveLink Volunteers</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-64 bg-emerald-700 text-white">
            <div class="p-6">
                ...
                <div class="space-y-1">
                    ...
                    <a href="volunteers.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-emerald-800">
                        <i class="fas fa-users"></i>
                        <span>Volunteers</span>
                    </a>
                    <a href="reports/reports.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-emerald-600 transition-colors">
        ...
        <div class="flex-1 overflow-auto">
            ...
            <div class="bg-white border-b p-4 flex justify-between items-center sticky top-0 z-10">
                <div>
                    <h1 class="text-xl font-semibold text-gray-800">Volunteers</h1>
                    <p class="text-sm text-gray-500">Manage and oversee volunteer sign-ups</p>
                </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex space-x-2">
                                <button class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md text-sm hover:bg-gray-200 transition-colors">View Events</button>
